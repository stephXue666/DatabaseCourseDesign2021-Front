				...
				<el-main>
					<el-card class="box-card">
						...
						<el-row justify="center">
							<el-col :span="12">
								<el-input v-model="searchInput" placeholder="输入酒店名称进行查询" style="margin-top: 2px;" prefix-icon="el-icon-office-building">
									<template #append>
										<el-button icon="el-icon-search" @click="searchHotelName"></el-button>
									</template>
								</el-input>
							</el-col>
						</el-row>
						...
						<el-row justify="center">
							<el-table :data="tableData" border style="width: 90%;margin-top: 10px">
								...
								<el-table-column prop="hotelProvince" label="省份" width="80">
								</el-table-column>
								<el-table-column prop="hotelCity" label="城市" width="80">
								</el-table-column>
								<el-table-column prop="hotelRegion" label="区" width="80">
								</el-table-column>
								<el-table-column prop="hotelAddress" label="地址" width="250">
								</el-table-column>
								<!--可筛选配图不全的酒店-->
								<el-table-column prop="hotelHavePicture" label="配图" width="80"
						...
						<el-dialog title="酒店详情" v-model="dialogDetails" width="80%">
							...
							<el-descriptions class="margin-top" :column="4" :size="size" border>
								...
								<el-descriptions-item>
									...
									<el-rate v-model="detailedInfo.score" disabled show-score text-color="#99A9BF"
